...
//                        //$(element).scooch();
                        var swiper = new Swiper($(element), {
                            ...
                            onTransitionEnd: function () {
                                //aguarda um tempo antes de pegar o valor da pagina ativa
                                var pagina_slide = $(element).find('.swiper-slide-active').index();                                    
                                paginaSelected = pagina_slide;
                                console.log('pagina atual = '+ paginaSelected);
                            }
                        });
//                        
//                        //swiper.slideTo( 2, 1000, false );
//                        
//                        //console.log($(element).find('.swiper-pagination'));
//                        console.log('slide iniciado');
//                    }
//                    else{ //se a pagina estiver definida inicio nela spaceBetween: 30,
//                        console.log(swiper);                        
//                        console.log('slide destruido');
//                        
...
//                                console.log('pagina atual = '+ paginaSelected);
//                            },
//                            initialSlide: paginaSelected
//                        });
//                        console.log('slide iniciado novamente');
//                        //swiper.slideTo( paginaSelected, 1000, false );
//                    }
                    //$(element).css('height', '100%');

                    //salva numero da pagina quando ela é trocada
//                    $(element).find('.swiper-wrapper').attrchange({
//                            trackValues: true,
